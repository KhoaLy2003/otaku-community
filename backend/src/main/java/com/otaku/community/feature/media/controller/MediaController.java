...
public class MediaController {
    ...
    public ResponseEntity<ApiResponse<Object>> uploadMedia(
        ...
        log.info("Received media upload request for file: {}", file.getOriginalFilename());

        MediaUploadResponse response = mediaService.uploadMedia(file);
        
        log.info("Media upload completed successfully. URL: {}", response.getUrl());
    ...
    public ResponseEntity<ApiResponse<String>> deleteMedia(
        ...
        log.info("Received media deletion request for public ID: {}", publicId);
        
        mediaService.deleteMedia(publicId);
        
        log.info("Media deletion completed for public ID: {}", publicId);
