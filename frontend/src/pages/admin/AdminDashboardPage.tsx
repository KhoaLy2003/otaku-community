        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard
                    ...
                    change={`${currentStats.newUsers24h} new in 24h`}
                    trend="up"
                    icon={Users}
                    color="blue"
                />
                <StatCard
                    title="Active Posts"
                    value={currentStats.activePosts.toLocaleString()}
                    change="Platform vitality"
                    trend="up"
                    icon={FileText}
                    color="orange"
                />
                ...
                <StatCard
                    ...
                    value={currentStats.moderationActions.toLocaleString()}
                    change="Total events logged"
                    trend="up"
                    icon={ShieldAlert}
                    color="green"
                />
                    ...
                    <Card className="rounded-3xl p-6">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <button className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-orange-50 text-gray-700 hover:text-orange-600 rounded-2xl transition-all text-sm font-bold border border-transparent hover:border-orange-100">
                                ...
                                Review Translations ({currentStats.pendingTranslations})
                            </button>
