...
import { mockSettings } from "@/data/admin";
...
export const SystemSettingsPage = () => {
    ...
    const toggleMaintenance = () => setSettings(prev => ({ ...prev, maintenanceMode: !prev.maintenanceMode }));
    const toggleRegistrations = () => setSettings(prev => ({ ...prev, allowRegistrations: !prev.allowRegistrations }));
